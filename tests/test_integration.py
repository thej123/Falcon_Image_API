...
# When we refractored the work in the last commit, we could have inadvertently introduced a functional bug into the 
# application that our unit tests would not have caught. Unexpected interaction between the application and the web 
# server, or between the application and any external services etc.
